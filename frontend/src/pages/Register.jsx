    ...
    <div className="flex min-h-screen overflow-hidden" style={{ background: '#F5EFFF' }}>
      ...
      <div className="w-[30%] flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <h1 className="text-2xl font-semibold mb-2" style={{ color: '#2B3A3A' }}>Create account</h1>
          <p className="text-sm mb-6" style={{ color: '#8A9A8E' }}>Start managing your tasks</p>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label className="block text-sm font-medium mb-1" style={{ color: '#2B3A3A' }}>Username</label>
              <input
                type="text"
                value={username}
          ...
          <p className="text-center text-sm mt-6" style={{ color: '#8A9A8E' }}>
            ...
            <Link to="/login" style={{ color: '#A294F9' }}>Log in</Link>
          </p>
        </div>
      </div>
